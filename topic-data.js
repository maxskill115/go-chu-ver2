...
const GO_CHU_TOPIC_TERMS = {
    ...
    food: [
        "cơm","bánh","rau","trái cây","sữa","nước cam","nước dừa","trà","táo","chuối","cam","xoài","dưa hấu","cà rốt","thịt","cháo","kẹo","kem","mật ong"
    ],
    nature: [
    ...
    body: [
        "tay","chân","mặt","tóc","răng","miệng","mắt","mũi","tai","đầu","cổ","vai","bụng","lưng","ngón tay","bàn tay","bàn chân","đánh răng","rửa mặt","rửa tay","rửa chân","chải tóc","buộc tóc","che miệng"
    ],
    colors: [
